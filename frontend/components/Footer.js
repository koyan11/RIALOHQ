...
export default function Footer() {
  return (
    <footer className="bg-[#0c0c0c] text-white w-full pt-16 pb-12 border-t border-white/5 relative overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row justify-between gap-12 mb-16">
          ...
          <div className="w-full md:w-5/12">
            <Link href="/" className="inline-block mb-6 group">
              <img src="/rialo-text-logo.png" alt="Rialo Logo" className="h-8 w-auto filter brightness-0 invert opacity-80 group-hover:opacity-100 transition-opacity" />
            </Link>
            <p className="font-headline text-[12px] text-white/40 leading-relaxed max-w-sm font-medium">
