        ...
        {activeView === 'stake' ? (
          <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-0 lg:gap-y-0 items-start">
              ...
              <div className="lg:col-start-1 lg:row-start-1 text-center mb-6 lg:mb-12 min-h-[auto] lg:min-h-[120px] flex flex-col justify-center animate-in fade-in slide-in-from-bottom-2 duration-300 delay-100">
                <h1 className="text-5xl text-black mb-4">Stake Assets</h1>
                <p className="text-zinc-500 max-w-xl mx-auto font-medium">Stake RLO or ETH to mint yield-bearing assets and auto-generate credits for a completely gasless experience.</p>
              </div>
              ...
              <div className="lg:col-start-2 lg:row-start-1 text-center mb-6 lg:mb-12 min-h-[auto] lg:min-h-[120px] flex flex-col justify-center animate-in fade-in slide-in-from-bottom-2 duration-300 delay-200">
                <h1 className="text-5xl text-black mb-4">Paymaster</h1>
                <p className="text-zinc-500 max-w-xl mx-auto font-medium">Power your on-chain experience with automated gas routing and AI credits.</p>
              </div>
              ...
              <div className="lg:col-start-1 lg:row-start-2 flex flex-col animate-in fade-in slide-in-from-bottom-2 duration-300 delay-150 mb-12 lg:mb-0">
                <div className="bg-[#0c0c0c] rounded-2xl p-8 md:p-12 shadow-xl border border-white/5 relative overflow-hidden group/card transition-all duration-500 h-full min-h-[650px] flex flex-col">
                  <div className="absolute top-0 right-0 w-32 h-32 bg-primary/5 rounded-full -mr-16 -mt-16 blur-3xl opacity-20"></div>
                  <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-white/10 via-white/5 to-transparent opacity-90"></div>

                  {/* Tab Toggle Container */}
                  <div className="flex bg-[#161616] rounded-2xl p-1 mb-8 border border-white/5 shadow-inner relative">
                    <button
                      onClick={() => setIsStaking(true)}
                      className={`flex-1 py-3 text-sm font-bold rounded-xl transition-all z-10 ${isStaking ? 'text-black' : 'text-white/40 hover:text-white'}`}
                    >
                      Stake
                    </button>
                    <button
                    ...
                    <div className={`absolute top-1 bottom-1 w-[calc(50%-4px)] bg-white border border-white/10 rounded-xl transition-transform duration-300 ease-out shadow-md ${isStaking ? 'left-1 translate-x-0' : 'left-1 translate-x-full ml-1'}`}></div>
                  </div>
                  ...
                  {isStaking ? (
                    <div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
                      ...
                      <div className="mb-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                          ...
                          >
                            <span className={`font-bold text-sm ${assetType === 'solo_rlo' ? 'text-white' : 'text-white/20'}`}>Single RLO</span>
                          ...
                          >
                            <span className={`font-bold text-sm ${assetType === 'pair' ? 'text-white' : 'text-white/20'}`}>Pair (RLO+ETH)</span>
                          ...
                          >
                            <span className={`font-bold text-sm ${assetType === 'solo_eth' ? 'text-white' : 'text-white/20'}`}>Single ETH</span>
                            ...
                            <div className="flex flex-col xl:flex-row xl:items-start justify-between gap-3">
                              <div className="w-full">
                                <input
                                  ...
                                  className="bg-transparent text-2xl md:text-3xl font-bold text-white outline-none w-full placeholder-white/10"
                                  placeholder="0.0"
                                />
                                <div className="text-[11px] text-white/20 font-medium mt-1">≈ ${((parseFloat(rloAmount) || 0) * 3).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
                              </div>
                              <div className="flex items-center gap-2 shrink-0">
                                {assetType === 'solo_rlo' && (
                                  <button
                                    onClick={() => setRloAmount(rloBal || "0")}
                                    className="text-[10px] font-bold text-white bg-white/5 hover:bg-white/10 px-2 py-1 rounded-md border border-white/10"
                                  >
                                    MAX
                                  </button>
                                )}
                                <div className="flex items-center gap-1.5 bg-[#0c0c0c] rounded-lg px-2.5 py-1.5 border border-white/10 shadow-sm">
                                  <Droplet className="w-4 h-4 text-white fill-white/10" />
                                  <span className="font-bold text-sm text-white/80">RLO</span>
                                </div>
                              </div>
                            </div>
                          </div>
                            ...
                            <div className="flex flex-col xl:flex-row xl:items-start justify-between gap-3">
                              <div className="w-full">
                                <input
                                  ...
                                  className="bg-transparent text-3xl font-headline font-bold text-white outline-none w-full placeholder:text-white/10"
                                  placeholder="0.0"
                                />
                              ...
                              <div className="flex items-center gap-2 shrink-0">
                                <div className="flex items-center gap-1.5 bg-[#0c0c0c] rounded-lg px-2.5 py-1.5 border border-white/10 shadow-sm">
                                  <div className="w-4 h-4 rounded-full bg-white/5 border border-white/20 flex items-center justify-center text-white/40 text-[9px] font-bold">Ξ</div>
                                  <span className="font-bold text-sm text-white/80">ETH</span>
                                </div>
                              </div>
                            </div>
                          </div>
                      ...
                      <div className="bg-[#161616] rounded-2xl p-6 mb-6 border border-white/5 shadow-inner relative overflow-hidden group">
                        <div className="flex justify-between items-center mb-4 relative z-10">
                          ...
                          <span className="font-headline font-bold text-white bg-white/5 border border-white/10 px-2.5 py-1 rounded-md text-xs">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 relative">
                          ...
                          >
                            <div className="flex justify-between items-center w-full">
                              ...
                              <span className="text-white text-[10px] font-bold bg-white/5 border border-white/10 px-2 py-0.5 rounded uppercase tracking-wider">High APY</span>
                            </div>
                          </button>
                          <button
                            onClick={() => {
                          ...
                          >
                            <div className="flex justify-between items-center w-full">
                              ...
                              <span className="text-white text-[10px] font-bold bg-white/5 border border-white/10 px-2 py-0.5 rounded uppercase tracking-wider">Stable</span>
                            </div>
                          </button>
                        </div>
                          ...
                          <div className="mt-4 animate-in fade-in slide-in-from-top-2 duration-300">
                            ...
                            <div className="flex flex-row gap-3 mb-3">
                              <button
                                ...
                                className={`px-4 py-1.5 rounded-full text-sm font-medium transition-all border ${rwaTarget === 'treasury' ? 'bg-white text-black shadow-[0_0_10px_rgba(255,255,255,0.2)] border-white' : 'bg-white/5 border-white/10 text-white/40 hover:border-white/20'}`}
                              >
                                🏛️ Treasuries
                              </button>
                              <button
                                onClick={(e) => { e.preventDefault(); setRwaTarget('real-estate'); }}
                                className={`px-4 py-1.5 rounded-full text-sm font-medium transition-all border ${rwaTarget === 'real-estate' ? 'bg-white text-black shadow-[0_0_10px_rgba(255,255,255,0.2)] border-white' : 'bg-white/5 border-white/10 text-white/40 hover:border-white/20'}`}
                              >
                                🏢 Real Estate
                              </button>
                              <button
                                onClick={(e) => { e.preventDefault(); setRwaTarget('gold'); }}
                                className={`px-4 py-1.5 rounded-full text-sm font-medium transition-all border ${rwaTarget === 'gold' ? 'bg-white text-black shadow-[0_0_10px_rgba(255,255,255,0.2)] border-white' : 'bg-white/5 border-white/10 text-white/40 hover:border-white/20'}`}
                              >
                                🪙 Gold
                              </button>
                            </div>
                      ...
                      <div className="mb-6">
                        <button
                          ...
                          className="w-full bg-white text-black py-5 rounded-2xl font-headline font-extrabold text-lg tracking-tight hover:bg-white/90 active:scale-[0.98] transition-all shadow-xl disabled:opacity-50"
                        >
                          {isSimulating ? (
                      ...
                      <div className="space-y-3.5 text-sm px-2">
                        <div className="flex justify-between items-start text-white/60">
                          ...
                          <div className="flex flex-col items-end gap-1">
                            {assetType !== 'solo_eth' && <span className="font-semibold text-[14px] bg-white/5 px-2 py-0.5 rounded border border-white/10 text-white/80">{numRlo.toLocaleString('en-US')} stRLO</span>}
                            {assetType !== 'solo_rlo' && <span className="font-semibold text-[14px] text-white/80 bg-white/5 px-2 py-0.5 rounded border border-white/10">{numEth.toLocaleString('en-US')} stETH</span>}
                          </div>
                        </div>
                        <div className="flex justify-between items-center text-white/60">
                          <span className="text-white/40 font-medium">Blended APY</span>
                    ...
                    <div className="py-12 text-center animate-in zoom-in-95 duration-300 flex flex-col items-center justify-center min-h-[500px]">
                      <div className="flex items-center justify-center gap-3 mb-3">
                        <p className="text-white/40 font-medium">Your Locked Balance</p>
                        <button
                      ...
                      <h2 className="text-3xl md:text-5xl font-extrabold text-white mb-2 drop-shadow-sm tracking-tighter">
                        {realStakedBalance.toLocaleString('en-US')} <span className="text-xl text-white/20 font-bold ml-1">RLO</span>
                      </h2>
                      <h2 className="text-3xl md:text-5xl font-extrabold text-white mb-8 drop-shadow-sm tracking-tighter">
                        {realStakedEthBalance.toLocaleString('en-US')} <span className="text-xl text-white/20 font-bold ml-1">ETH</span>
                      </h2>

                      <div className="inline-flex items-center gap-2 bg-[#161616] border border-white/5 px-5 py-2.5 rounded-xl mb-12 shadow-inner">
                      ...
                      <div className="w-full mt-auto">
                        <button
                          onClick={handleStake}
                          disabled={isSimulating}
                          className="w-full font-bold py-4 rounded-2xl transition-all border border-transparent shadow-lg text-[1.05rem] flex justify-center items-center gap-2 bg-white hover:bg-white/90 text-black hover:shadow-xl hover:-translate-y-0.5 active:translate-y-0"
                        >
                          {isSimulating ? <Loader2 className="w-5 h-5 animate-spin" /> : "Initiate Unstaking"}
                        </button>
                        <p className="text-center text-[11.5px] font-medium text-white/30 mt-3 animate-in fade-in">
              ...
              <div className="lg:col-start-2 lg:row-start-2 flex flex-col animate-in fade-in slide-in-from-bottom-2 duration-300 delay-250">
                <div className="bg-[#0c0c0c] rounded-2xl p-8 md:p-12 shadow-xl border border-white/5 relative overflow-hidden group transition-all duration-500 h-full min-h-[650px] flex flex-col">
                  ...
                  <div className="bg-[#161616] rounded-2xl p-10 border border-white/5 flex flex-col items-center shadow-inner w-full text-center relative overflow-hidden shrink-0 mb-8">
                    ...
                    <div className="absolute -right-6 -bottom-6 w-32 h-32 bg-gradient-to-br from-white/5 to-transparent rounded-full flex items-center justify-center border border-white/10 opacity-70 pointer-events-none transform rotate-12 transition-transform duration-500 group-hover/card:rotate-0 group-hover/card:scale-110">
                      <Droplet className="w-14 h-14 text-white/5 fill-white/5" />
                    </div>
                  </div>

                  {/* Paymaster Fee Schedule */}
                  <div className="mt-8 flex-1 flex flex-col">
                    <h3 className="text-zinc-400 text-[10px] font-bold uppercase tracking-[0.2em] font-label mb-4 flex items-center gap-2">
                      Paymaster Fee Schedule
                    </h3>
                    ...
                    <div className="space-y-0 bg-[#161616] rounded-2xl border border-white/5 shadow-inner flex flex-col">
                      <div className="flex items-center justify-between text-sm p-5 border-b border-white/5">
                        ...
                        <span className="font-headline font-bold text-white/20 text-[11px]">~0.05 Credits</span>
                      </div>
                      <div className="flex items-center justify-between text-sm p-5 border-b border-white/5">
                        <span className="text-white/60 font-medium">RWA Allocation</span>
                        <span className="font-headline font-bold text-white/20 text-[11px]">~0.50 Credits</span>
                      </div>
                    ...
                    <div className="mt-auto pt-8 w-full">
                      <button
                        ...
                        className={`w-full py-4 border rounded-xl font-bold text-[10px] uppercase tracking-widest transition-all shadow-sm ${sessionActive ? 'bg-green-500/10 text-green-400 border-green-500/20' : 'bg-white/5 hover:bg-white/10 border-white/10 text-white/20 hover:text-white'}`}
                      >
            ...
            <div className="mt-12 mb-24 max-w-7xl mx-auto px-4 md:px-0">
              <div className="bg-[#0c0c0c] rounded-2xl p-8 md:p-12 shadow-xl border border-white/5 relative overflow-hidden group">
                <div className="absolute top-0 right-0 w-64 h-64 bg-white/5 rounded-full -mr-32 -mt-32 blur-[100px] opacity-20"></div>
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-8 w-full relative z-10">
                  ...
                  <div className="w-full md:w-auto shrink-0">
                    <button
                      ...
                      className="bg-white text-black px-10 py-5 rounded-2xl font-headline font-extrabold text-lg tracking-tight hover:bg-white/90 active:scale-[0.98] transition-all shadow-xl disabled:opacity-50"
                    >
          ...
          <div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-zinc-500 max-w-xl mx-auto font-medium">Automatically diversify your yield into stable, institutional-grade real-world assets.</p>
              <button
                onClick={() => setActiveView('stake')}
                className="mt-6 inline-flex items-center gap-2 text-zinc-900 font-bold text-sm hover:underline underline-offset-8 transition-all"
              >
