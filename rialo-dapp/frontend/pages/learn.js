    ...
    <div className="bg-surface font-body text-on-surface antialiased selection:bg-primary selection:text-on-primary">
      ...
      <main className="max-w-[1200px] mx-auto px-8 py-24">
        ...
        <section className="p-12 md:p-24 text-center mb-32 text-[#111111]">
          ...
          <div className="mt-24 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-x-16 gap-y-20 items-center justify-items-center w-full max-w-[1100px] mx-auto">
            {[
              ...
              <div key={i} className="w-full h-10 flex items-center justify-center transition-all duration-300 hover:scale-110 cursor-default">
                <img 
                  src={`/contributors/${filename}`} 
                  alt="Contributor Logo" 
                  className="max-h-full max-w-full w-auto h-auto object-contain mix-blend-multiply grayscale opacity-60 hover:opacity-100 transition-opacity"
