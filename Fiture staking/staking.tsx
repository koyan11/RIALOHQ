...
export default function Home() {
  ...
  return (
    <main className={activeView === 'rwa' ? "min-h-screen bg-white text-black font-body antialiased selection:bg-primary/30 flex flex-col relative" : "min-h-screen bg-background text-on-background font-body antialiased selection:bg-primary/30 flex flex-col relative"}>
        ...
        {activeView === 'stake' ? (
          ...
          <div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-black/50 max-w-xl mx-auto font-medium">Automatically diversify your yield into stable, institutional-grade real-world assets.</p>
              <button
              ...
              <div className="flex flex-col gap-6">
                {[
                  ...
                  <div
                    ...
                    className={`transition-all duration-300 bg-[#0c0c0c] rounded-2xl p-6 border flex items-center justify-between gap-4 ${
                      vault.comingSoon
